...
class RobotDetector:
    def __init__(self, camera_index=0, grid_size=3):
        ...
        self.binary_threshold = 140  # Threshold for black/white conversion
        self.min_contour_area = 5   # Minimum area to consider as a robot
...
def main():
    ...
    detector = RobotDetector(camera_index=4, grid_size=3)
